...
let defaultPreference = `Regular`;

if (userPreference === `Sugar-free`) {
    console.log(`User's preferred type of Monster Energy drink: ${userPreference}`);
} else {
    console.log(`User's preferred type of Monster Energy drink: ${defaultPreference}`)
}
